...
//	
	...
	@Select("select QUIZID, OWNER, NAME, DATE, TIME, EXTRA_INFO as extraInfo,  UUID, EMAILS,DESCRIPTION ,start_time as startTime,end_time as endTime,signed_key as signedKey "
